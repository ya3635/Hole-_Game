...
namespace PaintIn3D
{
	/// <summary>This component moves the current <b>TileTransform</b> in a spiral pattern.</summary>
	[ExecuteInEditMode]
	[HelpURL(CwCommon.HelpUrlPrefix + "CwSpiral")]
	[AddComponentMenu(CwCommon.ComponentMenuPrefix + "Spiral")]
...
{
	using UnityEditor;
	using TARGET = CwSpiral;

	[CustomEditor(typeof(TARGET))]
	public class CwSpiral_Editor : CwEditor
	{
