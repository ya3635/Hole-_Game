...
namespace PaintIn3D
{
	/// <summary>This component allows you to move the current <b>TileTransform</b> using editor events (e.g. UI buttons).</summary>
	[HelpURL(CwCommon.HelpUrlPrefix + "CwTranslate")]
	[AddComponentMenu(CwCommon.ComponentMenuPrefix + "Translate")]
...
{
	using UnityEditor;
	using TARGET = CwTranslate;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class CwTranslate_Editor : CwEditor
	{
