...
namespace PaintIn3D
{
	...
	public abstract class CwHitScreenBase : CwHitPointers
	{
		...
		/// <summary>This allows you to specify the <b>TileTransform</b> when using <b>RotateTo = CustomRotation/CustomLocalRotation</b>.</summary>
...
namespace PaintIn3D
{
	...
	public class CwHitScreenBase_Editor : CwEditor
	{
		protected virtual void DrawBasic()
		{
			...
			Draw("rotateTo", "This allows you to control how the paint is rotated.\n\nNormal = The rotation will be based on a normal direction, and rolled relative to an up axis.\n\nWorld = The rotation will be aligned to the world, or given no rotation.\n\nThisRotation = The current TileTransform.rotation will be used.\n\nThisLocalRotation = The current TileTransform.localRotation will be used.\n\nCustomRotation = The specified TileTransform.rotation will be used.\n\nCustomLocalRotation = The specified TileTransform.localRotation will be used.");
			...
			{
				BeginIndent();
					Draw("customTransform", "This allows you to specify the TileTransform when using RotateTo = CustomRotation/CustomLocalRotation.");
				EndIndent();
			}
		}
