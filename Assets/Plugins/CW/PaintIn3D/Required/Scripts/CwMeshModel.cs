...
namespace PaintIn3D
{
	...
	public abstract class CwMeshModel : CwModel
	{
		...
		/// <summary>TileTransform the mesh with its position, rotation, and scale? Some skinned mesh setups require this to be disabled.</summary>
...
namespace PaintIn3D
{
	...
	public class CwMeshModel_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			Draw("includeScale", "TileTransform the mesh with its position, rotation, and scale? Some skinned mesh setups require this to be disabled.");
