...
namespace PaintIn3D
{
	...
	public class CwPaintDecal : MonoBehaviour, IHitPoint, IHitLine, IHitTriangle, IHitQuad, IHitCoord
	{
		...
		/// <summary>This allows you to adjust the tiling position + rotation + scale using a <b>TileTransform</b>.</summary>
		...
		protected override void OnInspector()
		{
			...
			if (DrawFoldout("Advanced", "Show advanced settings?") == true)
			{
				BeginIndent();
					...
					Draw("tileTransform", "This allows you to adjust the tiling position + rotation + scale using a TileTransform.");
