...
namespace PaintIn3D
{
	...
	public class CwPaintSphere : MonoBehaviour, IHitPoint, IHitLine, IHitTriangle, IHitQuad, IHitCoord
	{
		...
		public Transform ReferenceTransform { set { referenceTransform = value; } get { return referenceTransform; } } [SerializeField] private Transform referenceTransform;
		...
		private Vector3 HandleHitCommon(bool preview, float pressure, int seed, Quaternion rotation)
		{
			...
			var finalReferenceMatrix = referenceTransform != null ? referenceTransform.worldToLocalMatrix : Matrix4x4.identity;
			...
			CwCommandSphere.Instance.SetMaterial(BlendMode, finalHardness, finalColor, finalOpacity, tileTexture, finalTileMatrix, finalReferenceMatrix, tileOpacity, tileTransition);
		...
		protected override void OnInspector()
		{
			...
			if (DrawFoldout("Advanced", "Show advanced settings?") == true)
			{
				BeginIndent();
					...
					Draw("referenceTransform", "This allows you to");
