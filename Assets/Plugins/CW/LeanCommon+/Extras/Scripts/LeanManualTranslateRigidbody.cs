...
namespace Lean.Common
{
	...
	[HelpURL(LeanCommon.PlusHelpUrlPrefix + "LeanManualTranslateRigidbody")]
	[AddComponentMenu(LeanCommon.ComponentPathPrefix + "Manual Translate Rigidbody")]
...
namespace Lean.Common.Editor
{
	...
	public class LeanManualTranslateRigidbody_Editor : CwEditor
	{
